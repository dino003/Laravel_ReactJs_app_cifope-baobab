                                      ...
                                      <div class="modal-body">
                                          <form role="form" class="form-horizontal">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" name="titre" v-model="nouvelArticleParEmploye.titre"  class="form-control">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <textarea rows="10" cols="30" class="form-control" v-model="nouvelArticleParEmploye.contenu"   name="contenu"></textarea>             
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  <div class="col-lg-offset-2 col-lg-10">
                                                      <span class="btn green fileinput-button" >
                                                        ...
                                                        <input type="file" id="imageCommunautePratique1" @change="onImageChange" name="image"  style="display:none;">
                                                      </span>
                                                      <span class="btn green fileinput-button" >
                                                        ...
                                                        <input type="file" id="fichierCommunautePratique1" @change="onFichierChange" name="fichier"  style="display:none;" >
                                                      </span>
                                                      <span class="">
                                                        <input type="text" name="fichier" v-model="nouvelArticleParEmploye.nomFichier" placeholder="Donnez un nom au fichier" >
                                                      </span>
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                     ...
                     <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="settings">
                        ...
                        <h3 style="text-align:center">Apporter une information dans la communauté de pratiques</h3>
                        
                        <em class="btn btn-default pull-right" id="btnAjouter"  @click.prevent="initAdd">Nouveau <span class="badge" style="background: green;"> <i class="fa fa-plus"></i>
                        </span>
                      </em>
                      <button type="button" @click="initHide" class="close" id="closeForm"  aria-hidden="true" style="display:none;">×</button>
                    <hr><hr>
                      <form enctype="multipart/form-data" role="form" method="post" action="{{url('les_articles')}}"  class="form-horizontal" id="formCo" style="display:none;">
                           {{csrf_field()}}         
                                              ...
                                              <div class="form-group">
                                                  <!--<label class="col-lg-2 control-label">Contenu</label>-->
                                                  <div class="col-lg-12">
                                                      <textarea class="form-control communauteProfil" v-model="nouvelArticleParEmploye.contenu"  name="contenu"></textarea>             
                                                  </div>
                                              </div>
                                               ...
                                               <img style="max-height:100px; max-width:100px;" v-if="url" :src="url">
                                                    ...
                                                    <span v-if="nouvelArticleParEmploye.fichier"><i class="fa fa-file fa-2x"></i></span>
                                                    @{{nouvelArticleParEmploye.fichier.name}}
                                              ...
                                              <div class="form-group">
                                                  <div class="col-lg-offset-2 col-lg-10">
                                                      ...
                                                      <span class="btn green fileinput-button" >
                                                        <i class="fa fa-picture-o fa fa-white" @click.prevent="afficherWindowpourImage"></i>
                                                        <span @click.prevent="afficherWindowpourImage">Ajouter une image</span>
                                                        <input type="file" id="imageCommunautePratique" @change="onImageChange" name="image"  style="display:none;">
                                                      </span>
                                                      
                                                      <span class="btn green fileinput-button" >
                                                        <i class="fa fa-file fa fa-white" @click.prevent="afficherWindowpourFichier"></i>
                                                        <span @click.prevent="afficherWindowpourFichier">Attacher un fichier</span>
                                                        <input type="file" id="fichierCommunautePratique" @change="onFichierChange" name="fichier"  style="display:none;" >
                                                      </span>
                                                      <span class="">
                                                        <input type="text" name="fichier" v-model="nouvelArticleParEmploye.nomFichier" placeholder="Donnez un nom au fichier" >
                                                      </span>
                      ...
                      <h4 style="text-align:center">Les Articles que vous avez rédigés</h4>

                      <div class="qa-message-list" id="wallmessages">

               
               <div class="ui active dimmer" v-if="loadingPerso">

                    <div class="ui text loader">Chargement...</div>
            </div>
            <div class="message-item" v-for="(articlePerso, index) in articlesPerso" :key="articlePerso.id" id="m16">
            <div class="message-inner">
              <div class="message-head clearfix">
                <div class="avatar pull-left"><a href="#"><img :src="articlePerso.user.photo"></a></div>
                <div class="user-detail">
                  <h5 class="handle">@{{articlePerso.titre}}</h5>
                  <span style="cursor: pointer;" v-if="articlePerso.image || articlePerso.fichier" @click="showArticlePerso(index)" class="pull-right" title="Voir les Fichiers associés"><i class="fa fa-picture-o fa-2x"></i></span>
                    ...
                    <div class="asker-meta">
                      ...
                      <span class="qa-message-when">
                        <span class="qa-message-when-data">
                            <span v-if="articlePerso.publie" class="label label-success pull-right">visible</span>
                                  <span v-else class="label label-danger pull-right">Non visible</span>
                        </span>
                      </span>
                      <span class="qa-message-who">
                       <br>
                        <span v-if="articlePerso.lien" class="qa-message-who-pad"> Lien à consulter : <a :href="articlePerso.lien" target="_blank">  @{{articlePerso.lien}}</a></span>
              ...
              <div class="qa-message-content" v-html="articlePerso.contenu">
