...
<div class="modal-dialog">
 ...
 <div class="modal-body">
 <fieldset>
   <form method="POST" id="formulaire589" action="">
                            {{ csrf_field() }}
    <input name="nom_dossier[]" placeholder="Nom dossier" class="form-control item_name" type="text">
       ...
       <div class="modal-footer">
               <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>     
               <button type="submit" class="btn btn-primary has-spinner10000" name="modifier">Ajouter</button>
         </div>
    </form>
</fieldset>
...
<div class="modal-dialog">
 ...
 <fieldset>
<form method="post" id="formulaire1221" enctype="multipart/form-data" >
          {{ csrf_field() }}
...
<input type="file" accept=".jpeg,.jpg,.png,.gif,.doc,.dot,.docx,.dotx,.docm,.xlsx,.xlsm,.xlsb,.xltx,.xltm,.xls,.xlt,.xml,.xlam,.xla,.xlw,.xlr,.pptx,.pptm,.ppsm,.ppt,.potx,.potm,.pot,.ppsx,.pps,.ppam,.ppa,.mde,.accde,.adp,.accdp,.accdr,.one,.onepkg,.vsd,.vst,.vsdm,.mpt,.mpp,.pub,.pdf,.rar,.zip" name="file[]" id="image4" multiple>
...
<div class="modal-footer">
  <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>     
                                                <button type="submit" class="btn btn-primary has-spinner" name="modifier" id="ajoute4">Ajouter</button>
                    </div>
 </form>
</fieldset>
...
@section('document0110')
<script>
$(document).ready(function () {
    $("#ajoute4").prop('disabled', true);
  $( "#image4" ).change(function() {
   $("#ajoute4").prop('disabled', false);
});
...
$(document).ready(function () {
    ...
    $('.has-spinner10000').click(function (e) {
        var btn = $(this);
        $(btn).buttonLoader('start');
        e.preventDefault();
        var formData = new FormData($(this).parents('form')[0]);
